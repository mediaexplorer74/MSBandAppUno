...
{
    public sealed class BluetoothTransport : BluetoothTransportBase, IDeviceTransport, IReadableTransport, IDisposable
    {
        ...
        public static BluetoothDeviceInfo[] GetConnectedDevices(Guid serviceUuid, ILoggerProvider loggerProvider)
        {
            DeviceInformationCollection results;
            try
            {
                int millisecondsTimeout = 15000;//5000
                IAsyncOperation<DeviceInformationCollection> allAsync 
                    = DeviceInformation.FindAllAsync(RfcommDeviceService.GetDeviceSelector(RfcommServiceId.FromUuid(serviceUuid)));
        ...
        public static BluetoothTransport Create(IBandInfo deviceInfo, ILoggerProvider loggerProvider, ushort maxConnectAttempts = 1)
        {
        ...
        public static async Task<BluetoothTransport> CreateAsync(IBandInfo deviceInfo, ILoggerProvider loggerProvider, ushort maxConnectAttempts = 1)
        {
