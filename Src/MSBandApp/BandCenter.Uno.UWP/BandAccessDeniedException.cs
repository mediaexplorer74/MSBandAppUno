...
namespace Microsoft.Band
{
    public class BandAccessDeniedException : BandIOException
    {
        ...
        public BandAccessDeniedException(string message) : base(message)
        {
        }

        public BandAccessDeniedException(string message, Exception innerException) : base(message, innerException)
        {
        }
    }
}
