...
namespace Microsoft.Band
{
    public class BandStoreClient : BandClient
    {
        ...
        protected BluetoothDeviceInfo BluetoothBand
        {
            get
            {
                return bluetoothBand;
            }
        }
        ...
        public BandStoreClient(
          ...
          : base(deviceTransport, 
                loggerProvider, 
                applicationPlatformProvider)
        {
            bluetoothBand = deviceInfo;
            pushServiceTransport = pushTransport;
            ApplicationSuspensionManager.Instance.Suspending 
                += new EventHandler(AppSuspending);
        }
        ...
        protected override void ExecuteSensorSubscribeCommand(
            SubscriptionType type)
        {
            using CargoCommandWriter cargoCommandWriter = 
                ProtocolBeginWrite(DeviceCommands.CargoRemoteSubscriptionSubscribeId, 21, 
                CommandStatusHandling.ThrowOnlySeverityError);
