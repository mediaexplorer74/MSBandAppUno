...
public sealed class KdkSyncProgress : ProgressTracker
{
    ...
    public ProgressTrackerPrimitive CurrentTimeAndTimeZoneProgress
    {
        get
        {
            return children[0];
    ...
    public ProgressTrackerPrimitive EphemerisProgress
    {
        get
        {
            return children[1];
    ...
    public ProgressTrackerPrimitive TimeZoneProgress
    {
        get
        {
            return children[2];
    ...
    public ProgressTrackerPrimitive DeviceCrashDumpProgress
    {
        get
        {
            return children[3];
    ...
    public ProgressTrackerPrimitive DeviceInstrumentationProgress
    {
        get
        {
            return children[4];
    ...
    public ProgressTrackerPrimitive UserProfileProgress
    {
        get
        {
            return children[5];
    ...
    public ProgressTrackerPrimitive WebTilesProgress
    {
        get
        {
            return children[7];
    ...
    public KdkSyncProgress(IProgress<SyncProgress> reporter, SyncTasks syncTasks)
    ...
    public override void ChildUpdated()
    {
        cachedPercentage = null;
        reporter.Report(new SyncProgress(PercentageCompletion, State));
    }

    public void SetState(SyncState newState)
    {
        State = newState;
    }
}
