...
public static class CloudDeviceSettingsExtensions
{
    public static DeviceSettings ToDeviceSettings(this CloudDeviceSettings cloudDeviceSettings)
    {
    ...
    public static IDictionary<Guid, DeviceSettings> ToAllDeviceSettings(this IDictionary<Guid, CloudDeviceSettings> allCloudDeviceSettings)
    {
