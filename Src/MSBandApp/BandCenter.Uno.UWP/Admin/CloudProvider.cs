...
public sealed class CloudProvider
{
    ...
    public string UserAgent => userAgentHeader.Value;

    public CloudProvider(ServiceInfo serviceInfo)
    {
        if (serviceInfo == null)
        {
    ...
    public void SetUserAgent(string newUserAgent, bool appOverride)
    {
    ...
    public FileUploadStatus UploadFileToCloud(Stream stream, LogFileTypes logType, string uploadId, UploadMetaData metadata, CancellationToken cancellationToken)
    {
        if (stream == null)
        {
    ...
    public Dictionary<string, LogUploadStatusInfo> GetLogProcessingUpdate(IEnumerable<string> uploadIDs, CancellationToken cancellationToken)
    {
    ...
    public bool DownloadFile(string downloadFileUrl, Stream updateStream, TimeSpan timeout, params HttpHeader[] additionalHeaders)
    {
        return DownloadFile(downloadFileUrl, updateStream, timeout, CancellationToken.None, (IEnumerable<HttpHeader>)additionalHeaders);
    }

    public bool DownloadFile(string downloadFileUrl, Stream updateStream, TimeSpan timeout, IEnumerable<HttpHeader> additionalHeaders)
    {
        return DownloadFile(downloadFileUrl, updateStream, timeout, CancellationToken.None, additionalHeaders);
    }

    public bool DownloadFile(string downloadFileUrl, Stream updateStream, TimeSpan timeout, CancellationToken cancel, params HttpHeader[] additionalHeaders)
    {
        return DownloadFile(downloadFileUrl, updateStream, timeout, cancel, (IEnumerable<HttpHeader>)additionalHeaders);
    }

    public bool DownloadFile(string downloadFileUrl, Stream updateStream, TimeSpan timeout, CancellationToken cancel, IEnumerable<HttpHeader> additionalHeaders)
    {
        string responseContent = string.Empty;
    ...
    public EphemerisCloudVersion GetEphemerisVersion(CancellationToken cancellationToken)
    {
        string responseContent = string.Empty;
    ...
    public bool GetEphemeris(EphemerisCloudVersion ephemerisVersion, Stream updateStream, CancellationToken cancel)
    {
    ...
    public TimeZoneDataCloudVersion GetTimeZoneDataVersion(IUserProfile profile, CancellationToken cancellationToken)
    {
        string responseContent = string.Empty;
        TimeSpan timeout = TimeSpan.FromSeconds(20.0);
    ...
    public bool GetTimeZoneData(TimeZoneDataCloudVersion timeZoneDataVersion, IUserProfile profile, Stream updateStream)
    {
        TimeSpan timeout = TimeSpan.FromMinutes(2.0);
        return DownloadFile(timeZoneDataVersion.Url, updateStream, timeout, GetLocalizationHeadersFromProfile(profile));
    }

    public FirmwareUpdateInfo GetLatestAvailableFirmwareVersion(FirmwareVersions deviceVersions, bool firmwareOnDeviceValid, List<KeyValuePair<string, string>> queryParams, CancellationToken cancellationToken)
    {
        string responseContent = string.Empty;
        TimeSpan timeout = TimeSpan.FromSeconds(20.0);
    ...
    public void GetFirmwareUpdate(FirmwareUpdateInfo updateInfo, Stream updateStream, CancellationToken cancellationToken)
    {
    ...
    public CloudProfile GetUserProfile(CancellationToken cancellationToken)
    {
        string responseContent = string.Empty;
    ...
    public void SaveUserProfile(CloudProfile profile, bool createNew, CancellationToken cancellationToken)
    {
        string responseContent = string.Empty;
    ...
    public void SaveDeviceLinkToUserProfile(CloudProfileDeviceLink profile, CancellationToken cancellationToken)
    {
        string responseContent = string.Empty;
    ...
    public void SaveUserProfileFirmware(byte[] firmwareBytes, CancellationToken cancellationToken)
    {
        string responseContent = string.Empty;
