...
public class WebTileResource : IWebTileResource
{
    ...
    public async Task<object> DownloadResourceAsync(bool requiresXml = false)
    {
    ...
    public string GetUniqueItemId(XmlNamespaceHelper xmlnshelper, bool isRSS, IXmlNode node)
    {
        string text = null;
    ...
    public bool ItemIdIsInCache(string id)
    {
        bool result = false;
    ...
    public void AddItemIdsToCache(List<string> ids)
    {
        if (cacheInfo.FeedItemIds == null)
        {
    ...
    public List<Dictionary<string, string>> GetFeedContentMappings(XmlDocument data)
    {
    ...
    public void ResolveContentMappings(Dictionary<string, string> mappings, XmlDocument document)
    {
    ...
    public void ResolveContentMappings(Dictionary<string, string> mappings, JToken j)
    {
        foreach (KeyValuePair<string, string> item in Content)
        {
