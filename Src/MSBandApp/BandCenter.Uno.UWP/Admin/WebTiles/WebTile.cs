...
public class WebTile : IWebTile
{
    ...
    public List<string> iconFilenames;

    public Dictionary<string, int> iconIndices;
    ...
    public void ValidateTextBindings()
    {
    ...
    public void ValidateIconBindings()
    {
    ...
    public void ValidateAllPagesElementIds()
    {
        if (pages == null)
        {
            return;
