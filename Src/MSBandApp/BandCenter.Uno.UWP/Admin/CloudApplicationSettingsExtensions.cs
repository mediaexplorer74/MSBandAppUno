...
public static class CloudApplicationSettingsExtensions
{
    public static ApplicationSettings ToApplicationSettings(this CloudApplicationSettings cloudApplicationSettings)
    {
