...
{
    internal sealed class PushServiceTransport : BluetoothTransportBase, 
        IReadableTransport, IDisposable
    {
        ...
        {
            foreach (BluetoothDeviceInfo connectedDevice 
                in BluetoothTransport.GetConnectedDevices(
                    new Guid("{C742E1A2-6320-5ABC-9643-D206C677E580}"),
                    loggerProvider))
            {
