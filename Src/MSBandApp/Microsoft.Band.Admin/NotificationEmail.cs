...
{
    public class NotificationEmail : NotificationBase
    {
        ...
        public override int GetSerializedByteCount() => base.GetSerializedByteCount() + 2 + 2 + CargoFileTime.GetSerializedByteCount() + 1 + 1 + this.Name.LengthTruncatedTrimDanglingHighSurrogate(40) * 2 + this.Subject.LengthTruncatedTrimDanglingHighSurrogate(36) * 2;

        public override void SerializeToBand(ICargoWriter writer)
        {
        ...
        public override int GetSerializedProtobufByteCount()
        {
        ...
        public override void SerializeProtobufToBand(CodedOutputStream output)
        {
