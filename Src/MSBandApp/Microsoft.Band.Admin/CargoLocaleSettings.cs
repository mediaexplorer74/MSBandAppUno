...
namespace Microsoft.Band.Admin
{
    public sealed class CargoLocaleSettings
    {
        ...
        public static CargoLocaleSettings DeserializeFromBand(ICargoReader reader) => new CargoLocaleSettings()
        {
        ...
        public void DeserializeDeviceMasteredFieldsFromBand(ICargoReader reader, bool forExplicitSave)
        {
            if (forExplicitSave)
            {
        ...
        public void SerializeToBand(ICargoWriter writer)
        {
