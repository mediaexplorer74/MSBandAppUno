...
namespace Microsoft.Band.Admin
{
    public sealed class CargoSleepStatistics
    {
        ...
        public static int GetSerializedByteCount() => CargoSleepStatistics.serializedByteCount;

        public static CargoSleepStatistics DeserializeFromBand(ICargoReader reader) => new CargoSleepStatistics()
        {
