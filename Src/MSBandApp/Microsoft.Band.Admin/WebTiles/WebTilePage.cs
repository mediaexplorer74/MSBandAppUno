...
namespace Microsoft.Band.Admin.WebTiles
{
        ...
        private static Dictionary<string, WebTilePage.BandClassSpecificLblobs> predefinedLayoutDictionary = new Dictionary<string, WebTilePage.BandClassSpecificLblobs>()
    {
      ...
      },
      {
        ...
        public static byte[] GetLayoutBlob(string layoutName, BandClass bandClass) => bandClass == BandClass.Envoy ? WebTilePage.predefinedLayoutDictionary[layoutName].lblobV2 : WebTilePage.predefinedLayoutDictionary[layoutName].lblobV1;
