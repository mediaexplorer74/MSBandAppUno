...
namespace Microsoft.Band.Admin
{
    public sealed class FirmwareUpdateOverallProgress : ProgressTracker
    {
        ...
        public ProgressTrackerPrimitive Send2UpUpdateToDeviceProgress
        {
            get => this.children[1];
            private set => this.children[1] = value;
        }

        public ProgressTrackerPrimitive WaitToConnectAfter2UpUpdateProgress
        {
            get => this.children[2];
