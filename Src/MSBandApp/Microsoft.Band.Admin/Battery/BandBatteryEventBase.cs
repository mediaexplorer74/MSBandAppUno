...
{
    public abstract class BandBatteryEventBase
    {
        public static BandBatteryEventBase DeserializeFromBand(ICargoReader reader) => BandBatteryEventBase.GetEmptyBatteryEvent(reader);
