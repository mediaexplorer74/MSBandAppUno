...
namespace Microsoft.Band.Admin
{
    public sealed class CargoRunStatistics
    {
        ...
        public static int GetSerializedByteCount() => CargoRunStatistics.serializedByteCount;

        public static CargoRunStatistics DeserializeFromBand(ICargoReader reader) => new CargoRunStatistics()
        {
