...
namespace Microsoft.Band.Admin
{
    public sealed class CargoCall : NotificationBase
    {
        ...
        public CargoCall.PhoneCallType CallType { get; set; }

        public override int GetSerializedByteCount() => base.GetSerializedByteCount() + 2 + 4 + CargoFileTime.GetSerializedByteCount() + 1 + 1 + this.CallerName.LengthTruncatedTrimDanglingHighSurrogate(20) * 2;
