...
namespace Microsoft.Band.Admin
{
    public class NotificationTime
    {
        ...
        public static int GetSerializedByteCount() => 2;

        public static NotificationTime DeserializeFromBand(ICargoReader reader) => new NotificationTime(reader.ReadByte(), reader.ReadByte());
