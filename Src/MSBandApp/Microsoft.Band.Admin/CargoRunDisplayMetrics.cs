...
namespace Microsoft.Band.Admin
{
        ...
        private static readonly HashSet<RunDisplayMetricType> CargoValidMetrics = new HashSet<RunDisplayMetricType>()
    {
      ...
      RunDisplayMetricType.Pace
        ...
        public static int GetSerializedByteCount(DynamicAdminBandConstants constants) => constants.RunMetricsDisplaySlotCount * 2;

        public static CargoRunDisplayMetrics DeserializeFromBand(
          ICargoReader reader,
