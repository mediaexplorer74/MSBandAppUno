...
namespace Microsoft.Band.Admin
{
        ...
        private static readonly HashSet<BikeDisplayMetricType> CargoValidMetrics = new HashSet<BikeDisplayMetricType>()
    {
      ...
      BikeDisplayMetricType.Speed
        ...
        public bool IsValid(DynamicAdminBandConstants constants)
        {
        ...
        public static int GetSerializedByteCount(DynamicAdminBandConstants constants) => constants.BikeMetricsDisplaySlotCount * 2;

        public static CargoBikeDisplayMetrics DeserializeFromBand(
          ICargoReader reader,
