...
{
    public class DynamicBandConstants : BandTypeConstants, IDynamicBandConstants
    {
        public static readonly DynamicBandConstants CargoConstants = new(BandClass.Cargo);
        public static readonly DynamicBandConstants EnvoyConstants = new(BandClass.Envoy);
