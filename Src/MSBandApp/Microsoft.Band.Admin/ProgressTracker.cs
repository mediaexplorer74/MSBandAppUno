...
namespace Microsoft.Band.Admin
{
    ...
    {
        public ProgressTrackerPrimitive[] children;
        private double lastReportedProgress;
        public double? cachedPercentage;

        public ProgressTracker(ProgressTrackerPrimitive[] children) => this.children = children;

        public virtual double PercentageCompletion
        {
            get
            {
