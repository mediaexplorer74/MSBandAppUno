...
namespace Microsoft.Band.Admin
{
    public class CargoSystemTime
    {
        ...
        public static int GetSerializedByteCount() => 16;

        public static CargoSystemTime DeserializeFromBand(ICargoReader reader) => new CargoSystemTime()
        {
        ...
        public static DateTime DeserializeFromBandAsDateTime(
          ICargoReader reader,
          DateTimeKind kind)
        {
