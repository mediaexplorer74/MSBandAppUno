...
namespace Microsoft.Band.Admin
{
    public class CargoTimeZoneInfo
    {
        ...
        public static int GetSerializedByteCount() => CargoTimeZoneInfo.serializedByteCount;

        public static CargoTimeZoneInfo DeserializeFromBand(ICargoReader reader) => new CargoTimeZoneInfo()
        {
