...
namespace Microsoft.Band.Admin
{
    public sealed class CargoAutoResponseResult : IEnumerable<string>, IEnumerable
    {
        ...
        public const int MaxRepliesSerializedBytes = 80;
        ...
        public int GetSerializedByteCount(int bytesAvailable)
        {
            if (this.Count == 0)
                return 0;
        ...
        public void SerializeToBand(ICargoWriter writer, int bytesAvailable)
        {
            bytesAvailable = Math.Min(bytesAvailable, 80);
        ...
        public int GetSerializedProtobufByteCount()
        {
            if (this.Count == 0)
                return 0;
        ...
        public void SerializeProtobufToBand(CodedOutputStream output)
        {
            if (this.Count == 0)
                return;
            this.PopulateProtobufCandidates();
