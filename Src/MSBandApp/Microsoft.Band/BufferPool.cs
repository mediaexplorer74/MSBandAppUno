...
namespace Microsoft.Band
{
    public sealed class BufferPool
    {
        ...
        public PooledBuffer GetBuffer(bool zero = false) => GetBuffer(BufferSize);

        public PooledBuffer GetBuffer(int size, bool zero = false)
        {
        ...
        public void ReleaseBuffer(PooledBuffer buffer)
        {
