...
{
    public sealed class NotificationGenericClearTile : NotificationBase
    {
        public NotificationGenericClearTile(Guid tileId) : base(tileId)
        {
        }

        public override int GetSerializedProtobufByteCount() => ProtoGuid.GetSerializedProtobufByteCount() + CodedOutputStream.ComputeEnumSize(1) + 1;
