...
{
    public abstract class BandClient : IBandClient, IDisposable, IBandNotificationManager, IBandPersonalizationManager, IBandSensorManager, IBandTileManager
    {
        public readonly ILoggerProvider loggerProvider;
        public readonly IApplicationPlatformProvider applicationPlatformProvider;
        protected bool disposed;
        public object protocolLock;
        private IDeviceTransport deviceTransport;
        public FirmwareApp runningFirmwareApp;
        ...
        public HeartRateSensor heartRate;
        public ContactSensor contact;
        public SkinTemperatureSensor skinTemperature;
        public UVSensor uv;
        public PedometerSensor pedometer;
        public CaloriesSensor calories;
        public GsrSensor gsr;
        public RRIntervalSensor rrInterval;
        public AmbientLightSensor als;
        public BarometerSensor barometer;
        public AltimeterSensor altimeter;
        ...
        public BandClient(IDeviceTransport deviceTransport, ILoggerProvider loggerProvider, IApplicationPlatformProvider applicationPlatformProvider)
        {
        ...
        public FirmwareApp FirmwareApp => runningFirmwareApp;

        public CargoVersions FirmwareVersions { get; private set; }

        public BandTypeConstants BandTypeConstants => FirmwareVersions.ApplicationVersion.PCBId < 20 ? BandTypeConstants.Cargo : BandTypeConstants.Envoy;
        ...
        public void InitializeCachedProperties()
        {
        ...
        public FirmwareApp GetRunningFirmwareAppFromBand()
        {
        ...
        public CargoVersions GetFirmwareVersionsFromBand()
        {
            CheckIfDisposed();
        ...
        public void CheckFirmwareSdkBit(FirmwareSdkCheckPlatform platform, byte reserved)
        {
            CheckIfDisposed();
            CheckIfDisconnected();
        ...
        public void CheckIfDisconnectedOrUpdateMode()
        {
            CheckIfDisconnected();
        ...
        public void ShowDialogWithOwnerValidation(
          Guid tileId,
          string title,
          string body,
          CancellationToken cancel)
        ...
        public void SendMessageWithOwnerValidation(
          Guid tileId,
          string title,
          string body,
          DateTimeOffset timestamp,
        ...
        protected void ValidateMeTileImage(BandImage image, uint imageId = 4294967295)
        {
            ...
            switch (BandTypeConstants.BandType)
            {
                ...
                case BandType.Envoy:
                    ...
                    break;
                default:
                    throw new InvalidOperationException("public error: BandClass unrecognized");
            }
            if (imageId == 0U)
                throw new ArgumentOutOfRangeException(nameof(imageId));
        }

        public CargoStatus ProtocolRead(
          ushort commandId,
          int dataSize,
        ...
        public CargoCommandReader ProtocolBeginRead(
          ushort commandId,
          int bytesToRead,
        ...
        public CargoStatus ProtocolWrite(
          ushort commandId,
          int timeout = 5000,
        ...
        public CargoStatus ProtocolWriteWithArgs(
          ushort commandId,
          int argBufSize,
          Action<ICargoWriter> writeArgBuf,
          int timeout = 5000,
        ...
        public CargoStatus ProtocolWriteWithData(
          ushort commandId,
          int dataSize,
        ...
        public CargoCommandWriter ProtocolBeginWrite(
          ushort commandId,
          int dataSize,
          CommandStatusHandling statusHandling)
        {
        ...
        public static void CheckStatus(CargoStatus status, CommandStatusHandling statusHandling, ILoggerProvider loggerProvider)
        {
        ...
        public bool IsSensorSubscribed(SubscriptionType type) => SubscribedSensorTypes.Contains((byte)type);

        public void EventingSubscribe()
        {
            CheckIfDisposed();
            lock (streamingLock)
            {
        ...
        public void SensorSubscribe(SubscriptionType type)
        {
            CheckIfDisposed();
            lock (streamingLock)
            {
        ...
        public void EventingUnsubscribe()
        {
            CheckIfDisposed();
            lock (streamingLock)
            {
        ...
        public void SensorUnsubscribe(SubscriptionType type)
        {
            CheckIfDisposed();
            lock (streamingLock)
            {
        ...
        public void DispatchTileOpenedEvent(BandTileOpenedEvent tileEvent)
        {
        ...
        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        public void DispatchTileButtonPressedEvent(BandTileButtonPressedEvent tileEvent)
        {
        ...
        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        public void DispatchTileClosedEvent(BandTileClosedEvent tileEvent)
        {
        ...
        public bool SetPagesWithOwnerValidation(Guid tileId, CancellationToken token, PageData[] pages)
        {
        ...
        public void SetPages(Guid tileId, CancellationToken token, IEnumerable<PageData> pages)
        {
        ...
        public IList<TileData> GetInstalledTiles()
        {
        ...
        public IList<TileData> GetDefaultTilesInternal()
        {
