...
{
    public static class DeviceStatusCodeUtils
    {
        ...
        public static uint Success;

        public static uint MakeStatus(bool isError, Facility facility, ushort code)
        {
        ...
        public static uint MakeStatusCust(bool isError, Facility facility, ushort code) => (uint)((isError ? 1 : 0) << 31 | 536870912) | (uint)facility << 16 | code;

        public static bool IsSeverityError(uint status) => (status & 2147483648U) > 0U;
    }
}
