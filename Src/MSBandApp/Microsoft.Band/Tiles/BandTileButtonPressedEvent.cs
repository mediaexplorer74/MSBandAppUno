...
{
    public class BandTileButtonPressedEvent : BandTileEventBase, IBandTileButtonPressedEvent, IBandTileEvent
    {
        private const string PageIdName = "PageId";
        private const string ElementIdName = "ElementId";

        public BandTileButtonPressedEvent(DateTimeOffset timestamp) : base(timestamp)
        {
        }
        ...
        public override void Dispatch(BandClient client) => client.DispatchTileButtonPressedEvent(this);
