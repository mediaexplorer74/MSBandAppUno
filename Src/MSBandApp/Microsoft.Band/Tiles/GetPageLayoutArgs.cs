...
{
    public static class GetPageLayoutArgs
    {
        private const int serializedByteCount = 24;

        public static int GetSerializedByteCount() => 24;

        public static void SerializeToBand(ICargoWriter writer, Guid tileId, uint layoutIndex)
        {
