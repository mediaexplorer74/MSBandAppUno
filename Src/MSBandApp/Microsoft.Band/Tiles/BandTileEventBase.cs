...
namespace Microsoft.Band.Tiles
{
    public abstract class BandTileEventBase : IBandTileEvent
    {
        ...
        public abstract void Dispatch(BandClient client);

        public static int GetSerializedByteCount() => serializedByteCount;

        public static BandTileEventBase DeserializeFromBand(ICargoReader reader, DateTimeOffset timestamp, out byte[] tileFriendlyName)
        {
