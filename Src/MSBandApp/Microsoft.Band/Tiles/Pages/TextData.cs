...
namespace Microsoft.Band.Tiles.Pages
{
    public abstract class TextData : PageElementData
    {
        ...
        public TextData(PageElementType typeId, short elementId, string text) : base(typeId, elementId)
        {
        ...
        public override int GetSerializedLength() => base.GetSerializedLength() + 2 + SerializationText.Length * 2;
