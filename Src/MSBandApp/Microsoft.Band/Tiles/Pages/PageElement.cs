...
namespace Microsoft.Band.Tiles.Pages
{
    public abstract class PageElement
    {
        ...
        public const int SerializedByteCount = 36;

        public PageElement() : this(CommonElementColors.Black)
        {
        }

        public PageElement(BandColor color)
        {
            Visible = true;
        ...
        public virtual PageElementType TypeId => PageElementType.InvalidType;

        protected virtual int SerializedCustomByteCount => 0;

        public static ushort GetCheckNumber(PageElementType typeId) => (ushort)(ushort.MaxValue - typeId);

        public virtual int GetSerializedByteCountAndValidate(
        ...
        public virtual int GetElementCountAndIDs(HashSet<short> existingIDs)
        {
        ...
        public virtual void GenerateMissingIDs(HashSet<short> existingIDs, ref short nextId)
        {
            if (ElementId.HasValue)
            {
                short? elementId = ElementId;
        ...
        public virtual void SerializeCustomFieldsToBand(ICargoWriter writer)
        {
        }

        public virtual void SerializeElementsToBand(ICargoWriter writer)
        {
        }

        public static PageElement DeserializeFromBand(ICargoReader reader)
        {
        ...
        public virtual void DeserializeCustomFieldsFromBand(ICargoReader reader)
        {
        }

        public virtual void DeserializeElementsFromBand(ICargoReader reader, int childCount) => throw new InvalidOperationException();
        ...
        [Flags]
        public enum PageElementStyleMask : uint
        {
            None = 0,
