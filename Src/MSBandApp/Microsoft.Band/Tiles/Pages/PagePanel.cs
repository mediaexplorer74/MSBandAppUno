...
namespace Microsoft.Band.Tiles.Pages
{
    public abstract class PagePanel : PageElement
    {
        ...
        public override int GetSerializedByteCountAndValidate(HashSet<short> existingIDs, HashSet<PageElement> existingElements)
        {
        ...
        public override int GetElementCountAndIDs(HashSet<short> existingIDs)
        {
        ...
        public override void GenerateMissingIDs(HashSet<short> existingIDs, ref short nextId)
        {
        ...
        public override void SerializeElementsToBand(ICargoWriter writer)
        {
            foreach (PageElement element in Elements)
                element.SerializeToBand(writer);
        }

        public override void DeserializeElementsFromBand(ICargoReader reader, int childCount)
        {
