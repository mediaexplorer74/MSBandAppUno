...
namespace Microsoft.Band.Tiles.Pages
{
    public sealed class TextBlock : PageElement
    {
        ...
        public override PageElementType TypeId => PageElementType.Text;
        ...
        public override void SerializeCustomFieldsToBand(ICargoWriter writer)
        {
            writer.WriteUInt16((ushort)Font);
            writer.WriteInt16(Baseline);
        }

        public override void DeserializeCustomFieldsFromBand(ICargoReader reader)
        {
