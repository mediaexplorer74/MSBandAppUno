...
namespace Microsoft.Band.Tiles.Pages
{
    public sealed class WrappedTextBlock : PageElement
    {
        ...
        public override PageElementType TypeId => PageElementType.WrappableText;
        ...
        public override void SerializeCustomFieldsToBand(ICargoWriter writer) => writer.WriteUInt16((ushort)Font);

        public override void DeserializeCustomFieldsFromBand(ICargoReader reader) => Font = (WrappedTextBlockFont)reader.ReadUInt16();
