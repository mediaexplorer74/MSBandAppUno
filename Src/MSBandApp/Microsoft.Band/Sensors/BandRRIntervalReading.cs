...
{
    public class BandRRIntervalReading : BandSensorReadingBase, IBandRRIntervalReading, IBandSensorReading
    {
        ...
        public static BandRRIntervalReading DeserializeFromBand(
          ICargoReader reader,
