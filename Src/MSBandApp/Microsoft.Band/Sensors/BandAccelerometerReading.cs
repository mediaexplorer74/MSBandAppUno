...
{
    public class BandAccelerometerReading : BandSensorReadingBase, IBandAccelerometerReading, IBandSensorReading
    {
        ...
        public override void Dispatch(BandClient client) => client.accelerometer.ProcessSensorReading(this);

        public static int GetSerializedByteCount(RemoteSubscriptionSampleHeader header) => 6;

        public static BandAccelerometerReading DeserializeFromBand(
          ICargoReader reader,
