...
{
    public class BandPedometerReading : BandSensorReadingBase, IBandPedometerReading, IBandSensorReading
    {
        ...
        public static BandPedometerReading DeserializeFromBand(
          ICargoReader reader,
