...
{
    public class BandHeartRateReading : BandSensorReadingBase, IBandHeartRateReading, IBandSensorReading
    {
        ...
        public static BandHeartRateReading DeserializeFromBand(
          ICargoReader reader,
