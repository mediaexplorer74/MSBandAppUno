...
{
    public sealed class BandGyroscopeReading : BandAccelerometerReading, IBandGyroscopeReading, IBandAccelerometerReading, IBandSensorReading
    {
        ...
        public new static int GetSerializedByteCount(RemoteSubscriptionSampleHeader header) => 12;

        public static BandGyroscopeReading DeserializeFromBand(
          ICargoReader reader,
