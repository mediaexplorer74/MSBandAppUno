...
{
    public class BandGsrReading : BandSensorReadingBase, IBandGsrReading, IBandSensorReading
    {
        ...
        public static int GetSerializedByteCount(RemoteSubscriptionSampleHeader header) => 7;

        public static BandGsrReading DeserializeFromBand(
          ICargoReader reader,
