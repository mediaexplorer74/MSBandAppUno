...
{
    public sealed class BandDistanceReading : BandSensorReadingBase, IBandDistanceReading, IBandSensorReading
    {
        ...
        public static int GetSerializedByteCount(RemoteSubscriptionSampleHeader header)
        {
        ...
        public static BandDistanceReading DeserializeFromBand(
          ICargoReader reader,
