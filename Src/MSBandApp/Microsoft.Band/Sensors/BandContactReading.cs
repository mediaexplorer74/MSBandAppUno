...
{
    public class BandContactReading : BandSensorReadingBase, IBandContactReading, IBandSensorReading
    {
        ...
        public static int GetSerializedByteCount(RemoteSubscriptionSampleHeader header) => 3;

        public static BandContactReading DeserializeFromBand(
          ICargoReader reader,
