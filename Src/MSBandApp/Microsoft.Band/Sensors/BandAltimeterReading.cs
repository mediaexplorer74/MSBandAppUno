...
{
    public class BandAltimeterReading : BandSensorReadingBase, IBandAltimeterReading, IBandSensorReading
    {
        ...
        public static BandAltimeterReading DeserializeFromBand(
          ICargoReader reader,
