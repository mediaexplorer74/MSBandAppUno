...
{
    public class BandTypeConstants
    {
        public static readonly BandTypeConstants Cargo = new(BandType.Cargo);
        public static readonly BandTypeConstants Envoy = new(BandType.Envoy);
        ...
        public T GetBandSpecificValue<T>(T cargo, T envoy)
        {
            switch (BandType)
            {
                case BandType.Cargo:
