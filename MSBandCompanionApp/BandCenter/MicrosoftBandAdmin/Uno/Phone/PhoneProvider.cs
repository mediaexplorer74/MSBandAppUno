...
namespace Microsoft.Band.Admin.Phone
{
    internal class PhoneProvider : IPlatformProvider
    {
        ...
        public virtual byte[] ComputeHashMd5(byte[] data)
        {
            //FIXME
            return default;//HashAlgorithmProvider.OpenAlgorithm(HashAlgorithmNames.Md5)
        ...
        public virtual byte[] ComputeHashMd5(Stream data)
        {
            ...
            return default;//hash.GetValueAndReset().ToArray();
        }
    }
}
