...
namespace Microsoft.Band.Admin
{
    ...
    internal sealed class UserProfile : IUserProfile
    {
        ...
        "yyyy-MM-ddTHH:mm:sszzz", "yyyy-MM-ddTHH:mm:ss.fzzz",
        "yyyy-MM-ddTHH:mm:ss.ffzzz", "yyyy-MM-ddTHH:mm:ss.fffzzz",
        "yyyy-MM-ddTHH:mm:ssZ", "yyyy-MM-ddTHH:mm:ss.fZ",
        "yyyy-MM-ddTHH:mm:ss.ffZ",
        "yyyy-MM-ddTHH:mm:ss.fffZ"
        };

        private static readonly int DeserializeDeviceMasteredAppDataFromBand_FastForward1
                = CargoFileTime.GetSerializedByteCount() + 4 + 2 + 1 + 32;

        private const int DeserializeDeviceMasteredAppDataFromBand_FastForward2 = 2;

        private static readonly int DeserializeDeviceMasteredAppDataFromBand_FastForward3
                = CargoFileTime.GetSerializedByteCount() + 1 + CargoFileTime.GetSerializedByteCount()
                + 1 + CargoFileTime.GetSerializedByteCount() + 1 + CargoFileTime.GetSerializedByteCount() + 1;
