...
namespace Microsoft.Band.Admin
{
    ...
    {
        internal static CloudDeviceSettings ToCloudDeviceSettings(this DeviceSettings deviceSettings, 
            int Version)
        {
            ...
            {
                cloudDeviceSettings.FirmwareByteArray = Convert.ToBase64String(
                    deviceSettings.FirmwareByteArray);
            }
