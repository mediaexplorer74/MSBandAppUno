    ...
    internal static class WindowsDateTime
    {
        ...
        public static CargoTimeZoneInfo ToCargoTimeZone(this TIME_ZONE_INFORMATION timeZoneInfo)
        {
            ...
            if (timeZoneInfo.DaylightDate.Day == 0 && timeZoneInfo.DaylightDate.DayOfWeek == 0)
            {
                ...
                cargoTimeZoneInfo.ZoneOffsetMinutes = (short)(-(timeZoneInfo.Bias 
            ...
            else
            {
                ...
                cargoTimeZoneInfo.StandardDate = TranslateWindowsDSTTransitionDateToCargo(
                    timeZoneInfo.StandardDate);
                cargoTimeZoneInfo.DaylightDate = TranslateWindowsDSTTransitionDateToCargo(
                    timeZoneInfo.DaylightDate);
            }
            return cargoTimeZoneInfo;
        }

        private static CargoSystemTime TranslateWindowsDSTTransitionDateToCargo(SYSTEMTIME standardDate)
        {
