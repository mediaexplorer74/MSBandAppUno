...
namespace Microsoft.Band.Admin
{
    ...
    {
        private static readonly string[] DateTimeFormats = new string[9] { "o",
        ...
        "yyyy-MM-ddTHH:mm:ss.ffZ", "yyyy-MM-ddTHH:mm:ss.fffZ" };
        ...
        {
            if (DateTime.TryParseExact(serialized, DateTimeFormats, CultureInfo.InvariantCulture,
