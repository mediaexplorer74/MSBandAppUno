...
namespace Microsoft.Band.Admin
{
    ...
    {
        internal static void Unzip(IStorageProvider storageProvider, StorageProviderRoot root,
            Stream zipStream, string extractFolder)
        {
        ...
        private static void UnzipZipArchiveEntry(IStorageProvider storageProvider, 
            StorageProviderRoot root, ZipArchiveEntry entry, string entryRelativePath, string extractFolder)
        {
            ...
            using Stream destination = storageProvider.OpenFileForWrite(root,
