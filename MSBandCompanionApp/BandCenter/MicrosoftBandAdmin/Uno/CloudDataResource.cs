...
namespace Microsoft.Band.Admin
{
    ...
    internal sealed class CloudDataResource
    {
        ...
        public string LogTypeString
        {
            ...
            set
            {
                LogType = (Enum.TryParse<LogFileTypes>(value, 
                    ignoreCase: true, out var result) ? result : LogFileTypes.Unknown);
            }
        }
        ...
        private string UploadStatusString
        {
            ...
            set
            {
                UploadStatus = (Enum.TryParse<LogUploadStatus>
                    (value, ignoreCase: true, out var result) 
                    ? result 
                    : LogUploadStatus.Unknown);
            }
        }
